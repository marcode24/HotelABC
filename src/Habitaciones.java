...
public class Habitaciones extends javax.swing.JInternalFrame {
    ...
    private void obtenerDatos() {
        ...
        for(Habitacion datosHabitacion : listaHabitaciones) {
            modelo.addRow(new Object[]{
                datosHabitacion.getIdHabitacion(),
                datosHabitacion.getNombre(),
                datosHabitacion.getCapacidad(),
                "$ " + datosHabitacion.getPrecio(),
                datosHabitacion.getCantidadCamas() + " " + datosHabitacion.getCama(),
                datosHabitacion.getTamanioHabitacion() + " m²",
                datosHabitacion.getDescripcion()
            });
        }
    ...
    private void mostrarImagen(int index) {
        ...
        ImageIcon icono = new ImageIcon(listaHabitaciones.get(index).getImagen());
    ...
    private void initComponents() {
        ...
        tableHabitacion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre", "Capacidad", "Precio", "Camas", "Tamaño", "Descripcion"
            }
        ) {
        ...
        tableHabitacion.setMaximumSize(new java.awt.Dimension(1100, 600));
    ...
    private void tableHabitacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableHabitacionMouseClicked
        ...
        txtNombre.setText(listaHabitaciones.get(i).getNombre());
        txtCapacidad.setText(listaHabitaciones.get(i).getCapacidad() + "");
        txtPrecio.setText(listaHabitaciones.get(i).getPrecio().toString());
        txtCama.setText(listaHabitaciones.get(i).getCama());
        txtCantidadCamas.setText(listaHabitaciones.get(i).getCantidadCamas() + "");
        txtTamanioHabitacion.setText(listaHabitaciones.get(i).getTamanioHabitacion() + "");
        txtDescripcion.setText(listaHabitaciones.get(i).getDescripcion());
        mostrarImagen(i);
